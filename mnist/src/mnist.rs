...
// load image labels from data directory
...
fn main() {
    ...
    optimizer.add_argument(&mut pw1);
    optimizer.add_argument(&mut pb1);
    optimizer.add_argument(&mut pw2);
    optimizer.add_argument(&mut pb2);
